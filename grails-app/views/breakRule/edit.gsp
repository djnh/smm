...
<html>
	...
	<body>
		...
		<div id="edit-breakRule" class="row">
		    <div class="box col-md-12">
		        <div class="box-inner">
		            ...
		            <div class="box-content">
						...
						<g:form role="form" url="[resource:breakRuleInstance, action:'update']" method="PUT" >
		                    <g:hiddenField name="version" value="${breakRuleInstance?.version}" />
