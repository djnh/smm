...
<link href='${request.contextPath}/charisma/bower_components/fullcalendar/dist/fullcalendar.css'
	rel='stylesheet'>
<link href='${request.contextPath}/charisma/bower_components/fullcalendar/dist/fullcalendar.print.css'
	rel='stylesheet' media='print'>
<link href='${request.contextPath}/charisma/bower_components/chosen/chosen.min.css' rel='stylesheet'>
<link href='${request.contextPath}/charisma/bower_components/colorbox/example3/colorbox.css'
	rel='stylesheet'>
<link href='${request.contextPath}/charisma/bower_components/responsive-tables/responsive-tables.css'
	rel='stylesheet'>
<link
	href='${request.contextPath}/charisma/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css'
	rel='stylesheet'>
	...
	<div class="ch-container">
		...
		<footer class="row">
			<p class="col-md-9 col-sm-9 col-xs-12 copyright">
				&copy; <a href="" target="_blank">Muhammad Usman</a> 2012 - 2014
			</p>

			<p class="col-md-3 col-sm-3 col-xs-12 powered-by">
				Powered by: <a href="">Charisma</a>
			</p>
		</footer>
