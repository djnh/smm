						...
						<g:form role="form" url="[action:'produce']" onsubmit=" return validate()">
							...
							<div class="form-group">
		                        <label class="radio-inline">
				                    <input type="radio" name="produceType" id="produceType1" value="org"> 以单位为前缀
				                </label>
				                <label class="radio-inline">
				                    <input type="radio" name="produceType" id="produceType2" value="race"> 以比赛为前缀
				                </label>
				                <label class="radio-inline">
				                    <input type="radio" name="produceType" id="produceType3" value="all"> 全部连续
				                </label>
		                    </div>
